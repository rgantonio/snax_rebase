...
int main() {
    ...
    ****************************************************************************/
    ...
    if (snrt_global_core_idx() == 0) {
        ...
        set_streamer_csr(tempLoop0_A, tempLoop1_B, tempLoop1_A, tempStride0_A_out, tempStride1_A_out, tempStride0_B_out, tempStride1_B_out,
                         tempStride0_GEMM_C_out, tempStride1_GEMM_C_out, delta_local_A_out, delta_local_B_out,
                         delta_local_C_in);
    ...
    ****************************************************************************/
    ...
    if (snrt_global_core_idx() == 0) {
        ...
        // Set Streamer configuration CSR
        set_streamer_csr(tempLoop0_D, tempLoop1_C, tempLoop1_D, tempStride0_D_out, tempStride1_D_out, tempStride0_C_out, tempStride1_C_out,
                         tempStride0_GEMM_E_out, tempStride1_GEMM_E_out, delta_local_D_out, delta_local_C_in,
                         delta_local_E_in);
