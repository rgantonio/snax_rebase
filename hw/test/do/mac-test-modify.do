...
add wave -noupdate /tb_snax_cluster/i_cluster/TotalSnaxTcdmPorts
add wave -noupdate /tb_snax_cluster/i_cluster/SnaxSystem
add wave -noupdate /tb_snax_cluster/i_cluster/snax_req_o
add wave -noupdate /tb_snax_cluster/i_cluster/snax_qvalid_o
add wave -noupdate /tb_snax_cluster/i_cluster/snax_qready_i
add wave -noupdate /tb_snax_cluster/i_cluster/snax_resp_i
add wave -noupdate /tb_snax_cluster/i_cluster/snax_pvalid_i
add wave -noupdate /tb_snax_cluster/i_cluster/snax_pready_o
add wave -noupdate /tb_snax_cluster/i_cluster/snax_tcdm_req_i
add wave -noupdate /tb_snax_cluster/i_cluster/snax_tcdm_rsp_o
add wave -noupdate -divider <NULL>
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/SnaxTcdmPorts
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_qvalid_i
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_qready_o
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_req_i
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_resp_o
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_pvalid_o
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_pready_i
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_tcdm_req_o
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_tcdm_rsp_i
add wave -noupdate /tb_snax_cluster/i_snax_mac_0/snax_mem
add wave -noupdate -divider <NULL>
add wave -noupdate -divider <NULL>
add wave -noupdate -divider <NULL>
add wave -noupdate -divider <NULL>
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1472 ns} 0}
