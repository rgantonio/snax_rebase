...
# Description: Manual assembler for basic operations only
# -----------------------------
...
def decode(entry):
    ...
    if (entry[0] == 'addi'):
        ...
        rs1 = ext_type(int(entry[2].split('(')[1]
                           .strip('x').strip(')')), 'reg')
        f3 = '010'
        rd = ext_type(int(entry[1].strip('x').strip(',')), 'reg')
        op = '0000011'
        ...
        rs2 = ext_type(int(entry[1].strip('x').strip(',')), 'reg')
        f3 = '010'
        rs1 = ext_type(int(entry[2].split('(')[1]
                           .strip('x').strip(')')), 'reg')
        op = '0100011'
